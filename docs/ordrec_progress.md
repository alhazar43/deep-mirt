...
- **2026-06-10, DuoLingo Mini exploration branch created.** Branch `feat/duolingo-mini` off `feat/ordrec`; plan at `docs/duolingo_mini_plan.md`, research evidence at `docs/duolingo_mini_research_appendix.md`. Docs-only and rl/-adapter-only scope, zero or near-zero ma-irt edits.
